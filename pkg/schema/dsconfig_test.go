...
// settingsExamples documents one worked configuration per authentication.See
...
var settingsExamples = &pluginschema.SettingsExamples{
				...
				Value: map[string]any{
					...
					"secure": map[string]any{
						"azureClientSecret": map[string]any{
							"create": "REPLACE_WITH_CLIENT_SECRET",
						},
					},
				},
			},
