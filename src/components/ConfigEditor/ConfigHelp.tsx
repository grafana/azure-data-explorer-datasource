...
const isHelpOpen = useMemo(() => !isCredentialsComplete(getCredentials(options)), [options]);
  ...
  return (
    <ConfigSection title={t("components.config-help.title-configuration-help", "Configuration Help")} isCollapsible isInitiallyOpen={isHelpOpen}>
      <div className="grafana-info-box">
        <h5><Trans i18nKey="components.config-help.configuring-azure-explorer-database">Configuring Azure and your Azure Data Explorer Database</Trans></h5>
        <h5><Trans i18nKey="components.config-help.create-an-aad-application">1. Create an AAD application</Trans></h5>
        <p>
        ...
        <h5><Trans i18nKey="components.config-help.connect-application-database">2. Connect the AAD Application to a database user</Trans></h5>
        <p>
          <Trans i18nKey="components.config-help.connect-application-database-description" values={{ dotCommand: 'add' }}>
        ...
        <h5><Trans i18nKey="components.config-help.configure-the-connection-in-grafana">3. Configure the connection in Grafana</Trans></h5>
        <p>
