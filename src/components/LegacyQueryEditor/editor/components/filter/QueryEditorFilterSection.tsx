...
import { isFieldAndOperator, isOrExpression } from 'components/LegacyQueryEditor/editor/guards';
...
import { QueryEditorOperatorDefinition, QueryEditorPropertyDefinition } from '../../../../../schema/types';
